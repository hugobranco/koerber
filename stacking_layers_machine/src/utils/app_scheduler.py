...
class AppScheduler():
    ...
    app_scheduler = BlockingScheduler(daemon=True, timezone="Europe/Lisbon")
    ...
    def add_jobs(cls):
        ...
        cls.app_scheduler.add_job(
            ScheduleJobs.send_machine_data,
            'interval',
            seconds=int(CfgReader.MACHINE_DATA_TIME_SCHEDULER_SECONDS),
            id='send_machine_data'
        )
    ...
    def remove_jobs(cls):
        ...
        """
        cls.app_scheduler.remove_job(job_id='send_machine_data')
